...
function buyMagic(){
    var magicCost = Math.floor(50 * Math.pow(1.1,magic));     //works out the cost of this cursor
    ...
    var nextCost = Math.floor(15 * Math.pow(1.1,magic));       //works out the cost of the next cursor
